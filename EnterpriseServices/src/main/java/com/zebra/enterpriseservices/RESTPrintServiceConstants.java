...
public class RESTPrintServiceConstants {
    protected static final String TAG  ="RESTPrintService";

    // Shared preference keys
    protected static final String SHARED_PREFERENCES_NAME = "RESTPrintService";
